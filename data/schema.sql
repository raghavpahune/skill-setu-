...
ALTER TABLE jobs ADD COLUMN IF NOT EXISTS verification_method TEXT DEFAULT 'AUTOMATED_API_HASH';
ALTER TABLE jobs ADD COLUMN IF NOT EXISTS confidence INT DEFAULT 90;
ALTER TABLE jobs ADD COLUMN IF NOT EXISTS freshness_status TEXT DEFAULT 'NEW';
...
ALTER TABLE schemes ADD COLUMN IF NOT EXISTS verification_method TEXT DEFAULT 'GOVERNMENT_OFFICIAL';
ALTER TABLE schemes ADD COLUMN IF NOT EXISTS confidence INT DEFAULT 95;
ALTER TABLE schemes ADD COLUMN IF NOT EXISTS freshness_status TEXT DEFAULT 'RECENT';
