...
const CONTEXTUAL_PROMPTS = {
  ...
  student: [
    ...
    'What skills am I missing to become an EV Battery technician in Maharashtra?',
    'What is the step-by-step learning roadmap for Cloud DevOps specialists?',
    'Which accredited institutes offer data science and AI courses in Pune?',
  ],
  employer: [
